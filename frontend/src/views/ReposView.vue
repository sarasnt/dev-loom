...
/* right-anchored on purpose (the Push split button sits right-of-center); z-index matches the
   brainstorm menu's, above the sticky rail. */
.bmenu { position: absolute; top: calc(100% + 4px); right: 0; z-index: 60; min-width: 240px; background: var(--surface); border: 1px solid var(--line); border-radius: 10px; padding: 6px; box-shadow: 0 8px 24px rgba(0,0,0,0.35); }
