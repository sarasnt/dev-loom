...
export const fetchHandoffs = api.fetchHandoffs
export const generateHandoff = api.generateHandoff
export const deleteHandoff = api.deleteHandoff
...
export const fetchModelAdvanced = api.fetchModelAdvanced
export const saveModelAdvanced = api.saveModelAdvanced
export const fetchSettings = api.fetchSettings
export const saveTerminalWorkdir = api.saveTerminalWorkdir
export const addRepoDir = api.addRepoDir
export const removeRepoDir = api.removeRepoDir
export const syncRepos = api.syncRepos
...
export const repoWorktreeRemove = api.repoWorktreeRemove
export const repoBranchDelete = api.repoBranchDelete
export const repoPrune = api.repoPrune
...
export const saveAdvancedSettings = api.saveAdvancedSettings
...
export const fetchCapabilities = api.fetchCapabilities
export const addMcpServer = api.addMcpServer
export const removeMcpServer = api.removeMcpServer
export const togglePlugin = api.togglePlugin
export const saveSkill = api.saveSkill
export const fetchSkill = api.fetchSkill
export const removeSkill = api.removeSkill
export const installSkillRepo = api.installSkillRepo
export const fetchBackup = api.fetchBackup
export const previewBackup = api.previewBackup
